...
class Usuario {
    ...
    private $id ,$nombre ,$apellidos, $nombreUsuario ,$correo ,$clave ,$verificado ,$tipo ,$fechaalta;
    
    function __construct($id = null, $nombre = null, $apellidos = null, $nombreUsuario = null, $correo = null, $clave = null, $verificado = null, $tipo = null, $fechaalta = null) {
        $this->id = $id;
        $this->nombre = $nombre;
